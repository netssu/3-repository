...
config.NormalSpeed = 14
config.FollowingSpeed = 18
config.ChasingSpeed = 20
config.DetectionRange = 200 -- How far the monster can detect a player
config.DetectionFov = 180 --  Monster vision
