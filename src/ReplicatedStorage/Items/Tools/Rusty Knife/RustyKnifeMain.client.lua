...
--//Config
local attackRange = 4.8
local damage = MeleeModule:GetPlrDamage(Player) * 1.50 -- 50% More Damage
local maxHit = 1
local hitboxSize = Vector3.new(3, 2.9, attackRange)
local attackDelay = 0.38
local debounce = true
