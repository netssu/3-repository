-- Made by VroIok, last updated on 11/7/23 | Version 2.1
...
local currentSound = Instance.new("Sound", character.HumanoidRootPart)
	  ...
	  currentSound.RollOffMaxDistance = 40 -- When should the sound stop being heard? (in studs)
...
local soundToRemove = character:WaitForChild("HumanoidRootPart"):WaitForChild("Running", 30)
...
local function update()
	if not currentSound or not id or not volume or not playbackSpeed then return end
